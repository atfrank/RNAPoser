...
# script to get SMILES for all RNA-ligand systems used in our study
...
for rna in $rnas
do
    babel --title ${rna} -d -AddPolarH -isd ../decoys_set/poses/${rna}/lig.sd -isd ../decoys_set/poses/${rna}/lig.smi &> /dev/null
    cat ../decoys_set/poses/${rna}/lig.smi 
done