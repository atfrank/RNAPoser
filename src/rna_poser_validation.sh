...
then
    ...
    # get score
    python src/rna_poser.py --classifier classifier/eta${eta}/RF_${rmsd}.predictor.pkl  --features manuscript/output/features_${pdbid}_traj1.txt --output manuscript/output/poser-scores_${pdbid}.txt
fi
