...
then
    ...
    # get score
    python src/rna_poser.py --classifier classifier/RF_all_2.5.predictor.pkl  --features manuscript/output/features_${pdbid}_traj1.txt --output manuscript/output/poser-scores_${pdbid}.txt
fi
